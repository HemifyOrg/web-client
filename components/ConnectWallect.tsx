...
function ConnectWallet(props: { label: string }) {
  ...
  return (
    <>
      ...
      <div onClick={() => setShowConnectPopup(false)} className="absolute w-full h-full bg-[#000a] -top-8 lg:-left-8 -left-5 backdrop-blur-md"></div>
          <div className="flex lg:w-2/5 w-3/4 py-3 flex-col gap-4 z-50 px-5 border rounded-xl bg-white border-themeColor">
            {/* top */}
