  ...
  return (
    ...
    <div className=' w-[80%] m-auto'>
        ...
        <div className='bg-white w-[100%] rounded-2xl overflow-hidden'>
            ...
            <div className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>Wager Matched</p>
            ...
            <div  className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>New Message</p>
            ...
            <div  className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>Favourite</p>
            ...
            <div className='p-3 border-b-2 rounded-b-2xl'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>win or loss</p>
    ...
    <div className=' w-[80%] m-auto'>
        ...
        <div className='bg-white w-[100%] rounded-2xl overflow-hidden'>
            ...
            <div className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>New Follow</p>
            ...
            <div  className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>Offers and promotions</p>
            ...
            <div  className='p-3 border-b-2 rounded-b-2xl mb-3'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>Newsletter</p>
            ...
            <div className='p-3 border-b-2 rounded-b-2xl'>
                <div >
                    <p className='text-black font-semibold text-[1.1rem]'>Product Update</p>
