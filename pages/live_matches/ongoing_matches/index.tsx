...
const ongoingMatches = () => {
    ...
    <section className='mt-[6rem] bg-[#25282B] pt-[1rem] pb-[2rem]'>
        ...
        <div className='w-[80%] bg-[#FFF] flex justify-between m-auto rounded-lg p-[0.5rem]'>
            ...
            <div className='ml-[.4rem]'>
                <Image src={chelsea_logo} alt="chelsea's Logo" />
                <p className='text-[0.975rem] text-[#353535] font-bold leading-5 mt-[0.5rem] mb-[1rem]'>Chelsea</p>
                <div className='flex'>
                <p className='flex h-[100%] mr-[0.38rem]'>
                    <Image src={yellowCard} alt='yellow card' />
                    <span className='text-[.9rem] font-semibold text-[#353535]'>5</span>
                </p>

                <p className='flex h-[100%]'>
                    <Image src={redCard} alt='yellow card' />
                    <span className='text-[.9rem] font-semibold text-[#353535]'>0</span>
                </p>
                </div>
            </div>
            <div className='rounded w-[30%]'>
                <div className='flex w-[100%] justify-between'>
                    <p className='h-[1.5rem] px-[0.45rem] bg-[#FFDE59] text-[#000] font-bold'>3</p>
                    <p className='text-[#52575C] font-bold leading-4'>45"</p>
                    <p className='h-[1.5rem] px-[0.45rem] bg-[#FFDE59] text-[#000] font-bold'>1</p>
                </div>
            ...
            <Image src={RMadrid_logo} alt="Real Madrid's Logo" />
            <p className='text-[0.975rem] text-[#353535] font-bold leading-5 mt-[0.5rem] mb-[1rem]'>Real Madrid</p>
            <div className='flex'>
                <p className='flex h-[100%] mr-[0.38rem]'>
                    <Image src={yellowCard} alt='yellow card' />
                    <span className='text-[.9rem] font-semibold text-[#353535]'>5</span>
  ...
  <g opacity="0.6">
    <path d="M7 13L12 18L17 13M7 6L12 11L17 6" stroke="#FAF7F0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
            </svg>
            </div>
  ...
  <path d="M12 10L8 6L4 10" stroke="#CBCDCF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className=' w-[80%] mt-[.8rem] m-auto rounded-[0.5rem]'>
            ...
            <div className='flex justify-between bg-[#000] p-[1rem]'>
                {/* top div */}
                <div className='flex'>
                    <p className='flex text-[#CBCDCF]'><span>Both team scores</span> <svg className='cursor-pointer mt-[.2rem] ml-[0.28rem]' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 10 10" fill="none">
  <g clip-path="url(#clip0_9221_29760)">
    <path d="M5 6.6669V5.00024M5 3.33357H5.00417M1.25 3.30917V6.6913C1.25 6.83407 1.25 6.90545 1.27104 6.96912C1.28964 7.02544 1.32007 7.07715 1.36026 7.12077C1.4057 7.17007 1.4681 7.20474 1.5929 7.27407L4.67624 8.98704C4.79441 9.05269 4.85349 9.08551 4.91606 9.09838C4.97144 9.10977 5.02856 9.10977 5.08394 9.09838C5.14651 9.08551 5.20559 9.05269 5.32376 8.98704L8.4071 7.27407C8.5319 7.20474 8.5943 7.17007 8.63974 7.12077C8.67993 7.07715 8.71036 7.02544 8.72897 6.96912C8.75 6.90545 8.75 6.83407 8.75 6.6913V3.30917C8.75 3.16641 8.75 3.09502 8.72897 3.03136C8.71036 2.97503 8.67993 2.92333 8.63974 2.87971C8.5943 2.8304 8.5319 2.79574 8.4071 2.7264L5.32376 1.01344C5.20559 0.94779 5.14651 0.914966 5.08394 0.902097C5.02856 0.890707 4.97144 0.890707 4.91606 0.902097C4.85349 0.914966 4.79441 0.94779 4.67624 1.01344L1.5929 2.7264C1.4681 2.79574 1.4057 2.8304 1.36026 2.87971C1.32007 2.92333 1.28964 2.97503 1.27104 3.03136C1.25 3.09502 1.25 3.16641 1.25 3.30917Z" stroke="#FEEA98" stroke-width="1.26316" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
  ...
  <path d="M12 10L8 6L4 10" stroke="#CBCDCF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className=' w-[80%] mt-[.8rem] m-auto rounded-[0.5rem]'>
            ...
            <div className='flex justify-between bg-[#000] p-[1rem]'>
                {/* top div */}
                <div className='flex'>
                    <p className='flex text-[#CBCDCF]'><span>Over 1.5 goals</span> <svg className='cursor-pointer mt-[.2rem] ml-[0.28rem]' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 10 10" fill="none">
  <g clip-path="url(#clip0_9221_29760)">
    <path d="M5 6.6669V5.00024M5 3.33357H5.00417M1.25 3.30917V6.6913C1.25 6.83407 1.25 6.90545 1.27104 6.96912C1.28964 7.02544 1.32007 7.07715 1.36026 7.12077C1.4057 7.17007 1.4681 7.20474 1.5929 7.27407L4.67624 8.98704C4.79441 9.05269 4.85349 9.08551 4.91606 9.09838C4.97144 9.10977 5.02856 9.10977 5.08394 9.09838C5.14651 9.08551 5.20559 9.05269 5.32376 8.98704L8.4071 7.27407C8.5319 7.20474 8.5943 7.17007 8.63974 7.12077C8.67993 7.07715 8.71036 7.02544 8.72897 6.96912C8.75 6.90545 8.75 6.83407 8.75 6.6913V3.30917C8.75 3.16641 8.75 3.09502 8.72897 3.03136C8.71036 2.97503 8.67993 2.92333 8.63974 2.87971C8.5943 2.8304 8.5319 2.79574 8.4071 2.7264L5.32376 1.01344C5.20559 0.94779 5.14651 0.914966 5.08394 0.902097C5.02856 0.890707 4.97144 0.890707 4.91606 0.902097C4.85349 0.914966 4.79441 0.94779 4.67624 1.01344L1.5929 2.7264C1.4681 2.79574 1.4057 2.8304 1.36026 2.87971C1.32007 2.92333 1.28964 2.97503 1.27104 3.03136C1.25 3.09502 1.25 3.16641 1.25 3.30917Z" stroke="#FEEA98" stroke-width="1.26316" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
  ...
  <path d="M12 10L8 6L4 10" stroke="#CBCDCF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className=' w-[80%] mt-[.8rem] m-auto rounded-[0.5rem]'>
            ...
            <div className='flex justify-between bg-[#000] p-[1rem]'>
                {/* top div */}
                <div className='flex'>
                    <p className='flex text-[#CBCDCF]'><span>Over 2.5 goals</span> <svg className='cursor-pointer mt-[.2rem] ml-[0.28rem]' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 10 10" fill="none">
  <g clip-path="url(#clip0_9221_29760)">
    <path d="M5 6.6669V5.00024M5 3.33357H5.00417M1.25 3.30917V6.6913C1.25 6.83407 1.25 6.90545 1.27104 6.96912C1.28964 7.02544 1.32007 7.07715 1.36026 7.12077C1.4057 7.17007 1.4681 7.20474 1.5929 7.27407L4.67624 8.98704C4.79441 9.05269 4.85349 9.08551 4.91606 9.09838C4.97144 9.10977 5.02856 9.10977 5.08394 9.09838C5.14651 9.08551 5.20559 9.05269 5.32376 8.98704L8.4071 7.27407C8.5319 7.20474 8.5943 7.17007 8.63974 7.12077C8.67993 7.07715 8.71036 7.02544 8.72897 6.96912C8.75 6.90545 8.75 6.83407 8.75 6.6913V3.30917C8.75 3.16641 8.75 3.09502 8.72897 3.03136C8.71036 2.97503 8.67993 2.92333 8.63974 2.87971C8.5943 2.8304 8.5319 2.79574 8.4071 2.7264L5.32376 1.01344C5.20559 0.94779 5.14651 0.914966 5.08394 0.902097C5.02856 0.890707 4.97144 0.890707 4.91606 0.902097C4.85349 0.914966 4.79441 0.94779 4.67624 1.01344L1.5929 2.7264C1.4681 2.79574 1.4057 2.8304 1.36026 2.87971C1.32007 2.92333 1.28964 2.97503 1.27104 3.03136C1.25 3.09502 1.25 3.16641 1.25 3.30917Z" stroke="#FEEA98" stroke-width="1.26316" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
  ...
  <path d="M12 10L8 6L4 10" stroke="#CBCDCF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        ...
        <div className=' w-[80%] mt-[.8rem] m-auto rounded-[0.5rem]'>
            ...
            <div className='flex justify-between bg-[#000] p-[1rem]'>
                {/* top div */}
                <div className='flex'>
                    <p className='flex text-[#CBCDCF]'><span>Over 5.5 corners</span> <svg className='cursor-pointer mt-[.2rem] ml-[0.28rem]' xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 10 10" fill="none">
  <g clip-path="url(#clip0_9221_29760)">
    <path d="M5 6.6669V5.00024M5 3.33357H5.00417M1.25 3.30917V6.6913C1.25 6.83407 1.25 6.90545 1.27104 6.96912C1.28964 7.02544 1.32007 7.07715 1.36026 7.12077C1.4057 7.17007 1.4681 7.20474 1.5929 7.27407L4.67624 8.98704C4.79441 9.05269 4.85349 9.08551 4.91606 9.09838C4.97144 9.10977 5.02856 9.10977 5.08394 9.09838C5.14651 9.08551 5.20559 9.05269 5.32376 8.98704L8.4071 7.27407C8.5319 7.20474 8.5943 7.17007 8.63974 7.12077C8.67993 7.07715 8.71036 7.02544 8.72897 6.96912C8.75 6.90545 8.75 6.83407 8.75 6.6913V3.30917C8.75 3.16641 8.75 3.09502 8.72897 3.03136C8.71036 2.97503 8.67993 2.92333 8.63974 2.87971C8.5943 2.8304 8.5319 2.79574 8.4071 2.7264L5.32376 1.01344C5.20559 0.94779 5.14651 0.914966 5.08394 0.902097C5.02856 0.890707 4.97144 0.890707 4.91606 0.902097C4.85349 0.914966 4.79441 0.94779 4.67624 1.01344L1.5929 2.7264C1.4681 2.79574 1.4057 2.8304 1.36026 2.87971C1.32007 2.92333 1.28964 2.97503 1.27104 3.03136C1.25 3.09502 1.25 3.16641 1.25 3.30917Z" stroke="#FEEA98" stroke-width="1.26316" stroke-linecap="round" stroke-linejoin="round"/>
  </g>
  <defs>
