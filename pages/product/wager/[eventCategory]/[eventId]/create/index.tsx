...
const CreateWagerMainPage = () => {
  ...
  const [fetchFixture] = useLazyQuery(FIXTURE, {
    variables: {
      fixtureId: router.query.eventId,
    },
    onCompleted(data) {
      const { fixture } = data;
      setEvent(fixture);
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <div className="main-loader top-0 h-screen w-screen m-auto flex justify-center items-center">
          <div
          ...
          >
            ...
            <div className="flex flex-col gap-2 w-full mx-auto">
              ...
              <div className="bg-gray-50 rounded-2xl gap-10 w-full px-8 py-4 flex justify-between items-center shadow-sm">
                ...
                <div className="flex flex-col justify-center text-center text-gray-400 items-center gap-2 text-sm">
                  <span className="font-medium capitalize">
                    {/* convert date to fomart: 22/10/23 */}
                    {new Date(event?.date).toLocaleDateString()}
                  </span>
                  <span className="font-semibold capitalize flex gap-1">
                    {/* convert timestamp to fomart: 16:10 */}
                    <span>
                    ...
                    <span>
                      {event.timezone?.replace("_", " ").replace("/", " ")}
                    </span>
                  </span>
                </div>
                <div className="flex flex-col items-center justify-center gap-2">
            ...
            {/* tabs */}
            <div className="w-full sm:w-auto my-6">
              <FilterMenuComponent
                tabs={tabsList}
                ...
                <div className="flex flex-col pt-3 xs:text-base text-sm pb-2 xs:px-3 px-2 gap-2 justify-center items-center w-full">
                  <div className="flex gap-2 w-full">
                    ...
                    <div className="bg-gray-200 rounded-lg flex justify-center items-center xs:px-5 px-2 py-2 flex-col w-full h-full">
                      ...
                      <span className="xs:text-lg flex gap-1 text-base text-gray-900 font-medium mr-auto">
                        <span>
                          {new Date(event?.timestamp).toLocaleTimeString([], {
                            hour: "2-digit",
                            minute: "2-digit",
        ...
        <div className="flex flex-col justify-center items-center h-screen">
          ...
          <div className="text-2xl font-medium">Page not found</div>
